...
PATH5 = "BERTCNN_finetune0.pt"
model5 = torch.load(PATH5,map_location='cpu').cuda()

PATH6 = "BERTLSTM_finetune0.pt"
model6 = torch.load(PATH6,map_location='cpu').cuda()

PATH7 = "BERTCNN_finetune1.pt"
model7 = torch.load(PATH7,map_location='cpu').cuda()

PATH8 = "BERTLSTM_finetune1.pt"
model8 = torch.load(PATH8,map_location='cpu').cuda()

PATH9 = "BERTCNN_finetune2.pt"
model9 = torch.load(PATH9,map_location='cpu').cuda()

PATH10 = "BERTLSTM_finetune2.pt"
model10 = torch.load(PATH10,map_location='cpu').cuda()
...
for batch in test_dataloader:
    ...
    with torch.no_grad():
        ...
        out5 = model5(input_ids = input_ids, attention_mask = input_mask, token_type_ids = None)
        out6 = model6(input_ids = input_ids, attention_mask = input_mask, token_type_ids = None)
        out7 = model7(input_ids = input_ids, attention_mask = input_mask, token_type_ids = None)
        out8 = model8(input_ids = input_ids, attention_mask = input_mask, token_type_ids = None)
        out9 = model9(input_ids = input_ids, attention_mask = input_mask, token_type_ids = None)
        out10 = model10(input_ids = input_ids, attention_mask = input_mask, token_type_ids = None)
    ...
    pred7 = torch.argmax(out7, dim = 1)
    pred8 = torch.argmax(out8, dim = 1)
    pred9 = torch.argmax(out9, dim = 1)
    pred10 = torch.argmax(out10, dim = 1)


    pred = pred1 + pred2 + pred3 + pred5 + pred6 + pred7 + pred8 +pred9 +pred10
    pred[pred < 5] = 0
    pred[pred >= 5] = 1
